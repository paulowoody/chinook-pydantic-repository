...
from chinook_pydantic_repository import ArtistRepository, DatabasePoolManager
...
def main():
    ...
    try:
        ...
        print(
            "Because max_size > 3, the pool should give each worker a UNIQUE connection.\n"
        )
        ...
        print(
            "The pool should now REUSE PIDs seen above because they were returned to the pool.\n"
        )
